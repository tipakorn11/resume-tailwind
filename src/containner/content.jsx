...
const Content = () => {
  return (
    <div>
              <div className="bg-black h-[60vh]">asd</div>
          ...
          <div className="grid grid-cols-2 md:px-[20rem]  ">
            <div className="flex flex-col text-wrap  border-r-2 border-white mb-5">
              ...
              <label className="text-xs pr-4">
                working around ERP DBMS Student Bigdata and co-worker with Provincial Administrative Organization of nakhon ratchasima Machine
                maintenance Election library and job manage web application
              </label>
            </div>
